...
import Rajeev from "./SocialLinks/Rajeev-pic.jpeg";
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={Rajeev} className="w-screen rounded-lg"/>
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://www.linkedin.com/in/rajeev-yadav-7097b5270/">
                {" "}
            ...
            >
              <a href="https://github.com/RajeevYadav1999" target="#">
                {" "}
