    ...
    <>
      <div className="relative h-full">
        <div className={`${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          >
            I have Completed My <span className="font-bold">Master of Computer Applications (MCA) </span>From Panjab University, Chandigarh. <br/>
            My Specilization is in <span className="font-bold">Computer Applications.</span>
          ...
          <p className="lg:text-nowrap"
           style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}       
          >
            My aim is to leverage my skills in the MERN stack (MongoDB, Express.js, React.js, and Node.js) to <br/>develop efficient, scalable, and user-centered web applications. I aim to continuously expand <br/>my technical expertise, collaborate effectively within cross-functional teams, and <br/>deliver innovative solutions that enhance  user experiences and drive business growth. <br/>I
            create <span className="font-bold">web design</span> for different screen sizes.<br/>
            <br/>
